    ...
    public partial class FormRecebePagamento : Form
    {
        ...
        private void txt_valor_pago_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                //MessageBox.Show(valor_pago + " valor pago string " + valor_pago.ToString() + " " + valor_pago.ToString("0.00") + " " + valor_pago.ToString("0,00"3));
        ...
        private List<Item_Caixa> CarregaGridNaLista()
        {
            ...
            for (int i = 0; i < contexto.dataGrid_itens.RowCount - 1; i++)
            {
                ...
                ic.Produto = contexto.dataGrid_itens.Rows[i].Cells[1].Value.ToString();
